...
import net.sf.l2j.gameserver.events.l2jdev.EventConfig;
...
public class AdminEvents implements IAdminCommandHandler
{
	...
	private static void listEvents(Player activeChar)
	{
		...
		tb.append("<html><body>Edit the following events as you wish - <a action=\"bypass -h admin_configureEvent 0\">General Configs</a><br><a action=\"bypass -h admin_events\" width=54 height=15><font color=\"0000FF\">back</font></a><br1>");
		
		FastMap<Integer, String> events = EventManager.getInstance().getEventMap();
	...
	private static void showMainPage(Player activeChar, int eventId)
	{
		...
		if (eventId == 0)
		{
			...
			replyMSG.append("<center><font color=\"LEVEL\">[General Configs]</font></center><br><a action=\"bypass -h admin_events\" width=54 height=15><font color=\"0000FF\">back</font></a><br1>");
		...
		else
		{
			...
			replyMSG.append("<center><br1> <a action=\"bypass -h admin_events\" width=54 height=15><font color=\"0000FF\">back</font></a><br1> <font color=\"LEVEL\">[" + e.getString("eventName") + "]</font></center><br><br>");
			replyMSG.append("<table><tr><td><edit var=\"input\" width=\"190\"></td></tr></table><br>");
			replyMSG.append("<table><tr>");
