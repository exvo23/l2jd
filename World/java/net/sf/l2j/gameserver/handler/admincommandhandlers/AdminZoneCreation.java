...
{
	public static final List<Location> savedLocs = new ArrayList<>();
	public static final String fileName = "coordinates" + "%s" + ".xml";
	public static ZoneShape shape = ZoneShape.NONE;
	public static final int zDifference = 1000;
	public static final String maxLocs = "You have reached the maximum locations for this shape.";
	...
	public static int calcZ(boolean minZ)
	{
	...
	public static void store(Player gm)
	{
		if (!canStoreLocs(gm))
			return;
	...
	public static boolean canSaveLoc(Player activeChar)
	{
		switch (shape)
		{
			case NPoly:
	...
	public static boolean setRadius(int val)
	{
	...
	public static void openHtml(Player activeChar)
	{
