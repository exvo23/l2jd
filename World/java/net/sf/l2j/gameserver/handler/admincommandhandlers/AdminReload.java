...
public class AdminReload implements IAdminCommandHandler
{
		...
		try
		{
			do
			{
				...
				else if (type.startsWith("enchant"))
				{
					...
					player.sendMessage("Enchants Scroll Xml have been reloaded.");
				}
				...
				else if (type.startsWith("donate") && type.startsWith("dressme"))
				{
					DressmeArmorData.getInstance().reload();
					DressmeWeaponData.getInstance().reload();
					DressmeArmorJewels.getInstance().reload();
	...
	public void sendUsage(Player player)
	{
		...
		player.sendMessage("Usage : //reload <dressme|donate>");
	}
