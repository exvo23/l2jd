...
public class PaganKeys implements IItemHandler
{
			...
			case 8273:
				switch (doorId)
				{
					...
					case 19160009:
						...
						closeDoors(doorId);
						playable.destroyItem("Consume", 8273, 1, null, true);
						break;
			...
			case 8274:
				switch (doorId)
				{
					...
					case 19160012:
						DoorData.getInstance().getDoor(doorId).openMe();
						closeDoors(doorId);
						playable.destroyItem("Consume", 8274, 1, null, true);
						break;
			...
			case 8275:
				switch (doorId)
				{
					...
					case 19160017:
						DoorData.getInstance().getDoor(doorId).openMe();
						closeDoors(doorId);
						playable.destroyItem("Consume", 8275, 1, null, true);
						break;
	...
	private static void closeDoors(int doors)
	{
		...
		ThreadPool.schedule(new Runnable()
		{
			...
			public void run()
			{
				Door doorInstance = DoorData.getInstance().getDoor(doors);
