...
import net.sf.l2j.gameserver.handler.itemhandlers.custom.DungeonReset;
import net.sf.l2j.gameserver.handler.itemhandlers.custom.HeroHandler;
import net.sf.l2j.gameserver.handler.itemhandlers.custom.ItemSkinFree;
import net.sf.l2j.gameserver.handler.itemhandlers.custom.NobleItem;
import net.sf.l2j.gameserver.handler.itemhandlers.custom.PremiumHandler;
import net.sf.l2j.gameserver.handler.itemhandlers.custom.RemoveKarma;
...
public class ItemHandler
{
	...
	protected ItemHandler()
	{
		...
		registerHandler(new PremiumHandler());
		registerHandler(new HeroHandler());
		registerHandler(new ClanItem());
		registerHandler(new NobleItem());
		registerHandler(new SexCoin());
		registerHandler(new DeletePk());
		registerHandler(new RemoveKarma());
		registerHandler(new ClassItem());
		registerHandler(new ItemSkinFree());
