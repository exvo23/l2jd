 ...
 * 
 */
public class CommandDonateArmor
{
	...
	public static void AddItem(Player player)
	{
		...
		final ItemInstance item11 = player.addItem("AuctionPurchase", dress.getLegsId(), 1, player, true);
		item11.setEnchantLevel(dress.getEnchantLevel());
		player.useEquippableItem(item11, true);
		InventoryUpdate playerIU11 = new InventoryUpdate();
		playerIU11.addItem(item11);
		player.sendPacket(playerIU11);
