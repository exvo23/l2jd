...
public class SchedulingPattern
{
	 ...
	 */
	private static ValueMatcher buildValueMatcher(String str, ValueParser parser) throws Exception
	{
	 ...
	 * @throws Exception If the supplied pattern part is not valid.
	 */
	private static List<Integer> parseListElement(String str, ValueParser parser) throws Exception
	{
		StringTokenizer st = new StringTokenizer(str, "/");
	...
	private static List<Integer> parseRange(String str, ValueParser parser) throws Exception
	{
		if (str.equals("*"))
		{
