...
{
	protected static final Logger _log = Logger.getLogger(HeavyMedal.class.getName());
	
	private final int EVENT_MEDAL_COUNT = EventDropConfig.EVENT_MEDAL_COUNT;
	private final int EVENT_MEDAL_CHANCE = EventDropConfig.EVENT_MEDAL_CHANCE;
	
	private final int GLITTERING_MEDAL_COUNT = EventDropConfig.GLITTERING_MEDAL_COUNT;
	private final int GLITTERING_MEDAL_CHANCE = EventDropConfig.GLITTERING_MEDAL_CHANCE;
	...
	public HeavyMedal()
	{
		...
		_log.info("Heavy Medal Event Start.");
	}
