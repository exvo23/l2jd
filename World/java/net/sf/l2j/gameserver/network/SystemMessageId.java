...
public final class SystemMessageId
{
	 ...
	 * Message: $s1
	 */
	public static final SystemMessageId TOUR;
	
	/**
	 * ID: 2167<br>
	 * Message: $s1
	 */
	public static final SystemMessageId PVPZONE;
	...
	static
	{
		...
		TOUR = new SystemMessageId(2166);
		PVPZONE = new SystemMessageId(2167);
		TVT = new SystemMessageId(2168);
