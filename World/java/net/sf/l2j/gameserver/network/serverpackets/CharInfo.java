...
public class CharInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		writeD(_player.isSkinDisable() ? _player.getInventory().getItemIdFrom(Paperdoll.RHAND) :SkinWeaponId != null ? SkinWeaponId.getItemId() : _player.getInventory().getItemIdFrom(Paperdoll.RHAND));
