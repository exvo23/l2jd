...
public class UserInfo extends L2GameServerPacket
{
	...
	{
		final DressmeArmor SkinId = _player.getSkinArmor();
		final DressmeWeapon SkinWeaponId = _player.getSkinWeapon();
		writeC(0x04);
		writeD(_player.getX());
		writeD(_player.getY());
		writeD(_player.getZ());
		...
		writeD(SkinWeaponId != null ? SkinWeaponId.getItemId() : _player.getInventory().getItemObjectIdFrom(Paperdoll.RHAND));
		writeD(_player.getInventory().getItemObjectIdFrom(Paperdoll.LHAND));
		writeD(_player.isSkinDisable() ? _player.getInventory().getItemObjectIdFrom(Paperdoll.GLOVES) : SkinId != null ? SkinId.getGlovesId() : _player.getInventory().getItemObjectIdFrom(Paperdoll.GLOVES));
		writeD(_player.isSkinDisable() ? _player.getInventory().getItemObjectIdFrom(Paperdoll.CHEST) : SkinId != null ? SkinId.getChestId() : _player.getInventory().getItemObjectIdFrom(Paperdoll.CHEST));
		writeD(_player.isSkinDisable() ? _player.getInventory().getItemObjectIdFrom(Paperdoll.LEGS) : SkinId != null ? SkinId.getLegsId() : _player.getInventory().getItemObjectIdFrom(Paperdoll.LEGS));
		writeD(_player.isSkinDisable() ? _player.getInventory().getItemObjectIdFrom(Paperdoll.FEET) : SkinId != null ? SkinId.getFeetId() : _player.getInventory().getItemObjectIdFrom(Paperdoll.FEET));
		...
		writeD(_player.isDisableHair() ? _player.getInventory().getItemIdFrom(Paperdoll.HAIR) : SkinId != null ? SkinId.getHairId() : _player.getInventory().getItemObjectIdFrom(Paperdoll.HAIR));
		writeD(_player.isDisableHair() ? _player.getInventory().getItemIdFrom(Paperdoll.FACE) : SkinId != null ? SkinId.getHairId() : _player.getInventory().getItemObjectIdFrom(Paperdoll.FACE));
		
		writeD(_player.isDisableHair() ? _player.getInventory().getItemIdFrom(Paperdoll.HAIRALL) : SkinId != null ? SkinId.getHairId() : _player.getInventory().getItemIdFrom(Paperdoll.HAIRALL));
		...
		writeD(SkinWeaponId != null ? SkinWeaponId.getItemId() : _player.getInventory().getItemIdFrom(Paperdoll.RHAND));
		writeD(_player.getInventory().getItemIdFrom(Paperdoll.LHAND));
		writeD(_player.isSkinDisable() ? _player.getInventory().getItemIdFrom(Paperdoll.GLOVES) : SkinId != null ? SkinId.getGlovesId() : _player.getInventory().getItemIdFrom(Paperdoll.GLOVES));
		writeD(_player.isSkinDisable() ? _player.getInventory().getItemIdFrom(Paperdoll.CHEST) : SkinId != null ? SkinId.getChestId() : _player.getInventory().getItemIdFrom(Paperdoll.CHEST));
		writeD(_player.isSkinDisable() ? _player.getInventory().getItemIdFrom(Paperdoll.LEGS) : SkinId != null ? SkinId.getLegsId() : _player.getInventory().getItemIdFrom(Paperdoll.LEGS));
		writeD(_player.isSkinDisable() ? _player.getInventory().getItemIdFrom(Paperdoll.FEET) : SkinId != null ? SkinId.getFeetId() : _player.getInventory().getItemIdFrom(Paperdoll.FEET));
		writeD(_player.getInventory().getItemIdFrom(Paperdoll.CLOAK));
		writeD(_player.getInventory().getItemIdFrom(Paperdoll.RHAND));
		writeD(_player.isDisableHair() ? _player.getInventory().getItemIdFrom(Paperdoll.HAIR) : SkinId != null ? SkinId.getHairId() : _player.getInventory().getItemIdFrom(Paperdoll.HAIR));
		writeD(_player.isDisableHair() ? _player.getInventory().getItemIdFrom(Paperdoll.FACE) : SkinId != null ? SkinId.getHairId() : _player.getInventory().getItemIdFrom(Paperdoll.FACE));
