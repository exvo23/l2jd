...
public final class Say2 extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (EventManager.getInstance().isRegistered(player) && !EventManager.getInstance().getCurrentEvent().onSay(SayType.TELL, player, _text))
		{
			player.sendMessage("You cannot talk right now.");
			return;
		}
