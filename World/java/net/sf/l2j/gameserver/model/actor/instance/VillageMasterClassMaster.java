 ...
 */
public class VillageMasterClassMaster extends Folk
{
	
	boolean flip = true;
	
	public VillageMasterClassMaster(int objectId, NpcTemplate template)
	{
	...
	public String getHtmlPath(int npcId, int val)
	{
		...
		return "data/html/mods/ClassMaster/" + filename + ".htm";
	}
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("change_class"))
		{
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile("data/html/mods/ClassMaster/ok.htm");
		...
		else if (command.startsWith("Subclass"))
		{
			...
			switch (cmdChoice)
			{
				case 0: // Subclass change menu
					html.setFile("data/html/mods/ClassMaster/SubClass.htm");
					break;
				...
				case 1: // Add Subclass - Initial
					...
					if (player.getSubClasses().size() >= Config.MAX_SUBCLASS_FORBASE)
					{
						html.setFile("data/html/mods/ClassMaster/SubClass_Fail.htm");
						break;
					}
					...
					for (ClassId subClass : subsAvailable)
					{
						...
						StringUtil.append(sb, "<button value=\"" + subClass + "\" action=\"bypass -h npc_%objectId%_Subclass 4" + " " + subClass.getId() + "\" width=\"139\" height=\"21\" back=\"L2UI_CH3.bigbutton3_over" + "\" fore=\"L2UI_CH3.bigbutton3" + "\">");
						
					}
					
					html.setFile("data/html/mods/ClassMaster/SubClass_Add.htm");
				...
				case 2: // Change Class - Initial
					...
					if (player.getSubClasses().isEmpty())
						html.setFile("data/html/mods/ClassMaster/SubClass_ChangeNo.htm");
					else
					{
						sb = new StringBuilder(300);
						...
						if (checkVillageMaster(player.getBaseClass()))
							...
							StringUtil.append(sb, "<button value=\"" + PlayerData.getInstance().getClassNameById(player.getBaseClass()) + "\" action=\"bypass -h npc_%objectId%_Subclass 5 0" + "\" width=\"139\" height=\"21\" back=\"L2UI_CH3.bigbutton3_over" + "\" fore=\"L2UI_CH3.bigbutton3" + "\"><br1>");
						...
						if (sb.length() > 0)
						{
							html.setFile("data/html/mods/ClassMaster/SubClass_Change.htm");
							html.replace("%list%", sb.toString());
						}
						else
							html.setFile("data/html/mods/ClassMaster/SubClass_ChangeNotFound.htm");
					}
					break;
				...
				case 3: // Change/Cancel Subclass - Initial
					if (player.getSubClasses().isEmpty())
					{
						html.setFile("data/html/mods/ClassMaster/SubClass_ModifyEmpty.htm");
						break;
					}
					
					html.setFile("data/html/mods/ClassMaster/SubClass_Modify.htm");
					if (player.getSubClasses().containsKey(1))
						html.replace("%sub1%", PlayerData.getInstance().getClassNameById(player.getSubClasses().get(1).getClassId()));
					else
						
						html.replace("<center><button value=\"" + "%sub1%" + "\" action=\"bypass -h npc_%objectId%_Subclass 6 1" + "\" width=\"90\" height=\"16\" back=\"L2UI_CH3.br_bar2_hp1" + "\" fore=\"L2UI_CH3.br_bar2_hp1" + "\"></center><br>", "");
					
					if (player.getSubClasses().containsKey(2))
						html.replace("%sub2%", PlayerData.getInstance().getClassNameById(player.getSubClasses().get(2).getClassId()));
					else
						
						html.replace("<center><button value=\"" + "%sub2%" + "\" action=\"bypass -h npc_%objectId%_Subclass 6 2" + "\" width=\"90\" height=\"16\" back=\"L2UI_CH3.br_bar2_hp1" + "\" fore=\"L2UI_CH3.br_bar2_hp1" + "\"></center><br>", "");
					
					if (player.getSubClasses().containsKey(3))
						html.replace("%sub3%", PlayerData.getInstance().getClassNameById(player.getSubClasses().get(3).getClassId()));
					else
						html.replace("<center><button value=\"" + "%sub3%" + "\" action=\"bypass -h npc_%objectId%_Subclass 6 3" + "\" width=\"90\" height=\"16\" back=\"L2UI_CH3.br_bar2_hp1" + "\" fore=\"L2UI_CH3.br_bar2_hp1" + "\"></center><br>", "");
					break;
				...
				case 4: // Add Subclass - Action (Subclass 4 x[x])
					...
					if (allowAddition && isValidNewSubClass(player, paramOne))
					{
						...
						html.setFile("data/html/mods/ClassMaster/SubClass_AddOk.htm");
						player.sendPacket(SystemMessageId.ADD_NEW_SUBCLASS); // Subclass added.
					}
					else if (!player.addSubClass(paramOne, player.getSubClasses().size() + 1))
						return;
				...
				case 5: // Change Class - Action
					...
					{
						html.setFile("data/html/mods/ClassMaster/SubClass_Current.htm");
						break;
					}
				...
				case 6: // Change/Cancel Subclass - Choice
					// validity check
					if (paramOne < 1 || paramOne > Config.MAX_SUBCLASS_FORBASE)
						return;
					...
					{
						case 1:
							html.setFile("data/html/mods/ClassMaster/SubClass_ModifyChoice1.htm");
							break;
						
						case 2:
							html.setFile("data/html/mods/ClassMaster/SubClass_ModifyChoice2.htm");
							break;
						
						case 3:
							html.setFile("data/html/mods/ClassMaster/SubClass_ModifyChoice3.htm");
							break;
						
						default:
							html.setFile("data/html/mods/ClassMaster/SubClass_ModifyChoice.htm");
					}
					html.replace("%list%", sb.toString());
					break;
				...
				case 7: // Change Subclass - Action
					...
					if (player.modifySubClass(paramOne, paramTwo))
					{
						...
						html.setFile("data/html/mods/ClassMaster/SubClass_ModifyOk.htm");
