...
public abstract class Playable extends Creature
{
	...
	public boolean doDie(Creature killer)
	{
		...
		else if (isInsideZone(ZoneId.BOSS))
		{
			...
			if (Config.CHAOTIC_LEAVE_BUFFS_ON_DIE)
			{
				...
				if (actingPlayer.getClan() != null)
					World.QuakeAnnounce(getName() + " of the clan" + actingPlayer.getClan().getName() + " had his ass wiped and get self!");
				else
					World.QuakeAnnounce(getName() + " had his ass wiped and get self!");
			}
		}
	...
	public boolean isAttackableWithoutForceBy(Playable attacker)
	{
		...
		// No checks for Playables in arena.
		if (!attackerPlayer.isInFunEvent() && isInArena() && attacker.isInArena() && !(sameParty || sameCommandChannel))
			return true;
