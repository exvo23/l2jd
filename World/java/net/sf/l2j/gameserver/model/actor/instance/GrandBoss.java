	...
	public boolean doDie(Creature killer)
	{
		...
		if (player != null)
		{
			if (player.getClan() != null)
				World.announceToOnlinePlayers("Grand Boss: " + getName() + " was killed by " + player.getName() + " of the clan: " + player.getClan().getName(), true);
			else
				World.announceToOnlinePlayers("Grand Boss: " + getName() + " was killed by " + player.getName(), true);
