...
public class Door extends Creature implements IGeoObject
{
	...
	public boolean isAttackableBy(Creature attacker)
	{
		...
		if (EventManager.getInstance().isRunning() && EventManager.getInstance().isRegistered(attacker))
		{
			if (!EventManager.getInstance().getCurrentEvent().isAttakDoord(getDoorId(), attacker))
				return true;
		}
