...
public final class SubClass
{
	...
	public SubClass(int classId, int classIndex)
	{
		_class = ClassId.VALUES[classId];
		_classIndex = classIndex;
		_exp = PlayerLevelData.getInstance().getPlayerLevel(Config.SUB_CLASS_LEVEL_SET).getRequiredExpToLevelUp();
		_sp = 0;
		_level = Config.SUB_CLASS_LEVEL_SET;
	}
	...
	{
		_level = MathUtil.limit(level, Config.SUB_CLASS_LEVEL_SET, PlayerLevelData.getInstance().getRealMaxLevel());
	}
}