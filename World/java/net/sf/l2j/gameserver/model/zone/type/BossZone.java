	...
	protected void onEnter(Creature character)
	{
		...
		if (_enabled)
		{
			if (character instanceof Player)
			{
				...
				if (player.isGM() || _invadeTime == 0 || player.getMemos().containsKey("GrandBossTeleporters_Valakas") || player.getMemos().containsKey("GrandBossTeleporters_Lindvior") || player.getMemos().containsKey("GrandBossTeleporters_Fafurion"))
					return;
			...
			else if (character instanceof Summon)
			{
				...
				if (player != null)
				{
					if (_allowedPlayers.contains(player.getObjectId()) || player.isGM() || _invadeTime == 0 || player.getMemos().containsKey("GrandBossTeleporters_Valakas") || player.getMemos().containsKey("GrandBossTeleporters_Lindvior") || player.getMemos().containsKey("GrandBossTeleporters_Fafurion"))
						return;
