...
{
	public static final DateTimeFormatter PETTERN = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm");
	...
	/**
	 * @param email : The {@link String} to test.
	 * @return True if the {@link String} is valid email address.
	 */
